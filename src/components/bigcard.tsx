export function BigCard() {
    return (
        <div className="flex flex-col-reverse sm:flex-row justify-around gap-3 w-full h-80 bg-[#EAEEEF] rounded-4xl">
            <div className="flex flex-col gap-4 p-10 justify-between">
                ...
                <button className="bg-black rounded-xl w-full text-white py-3">Shop Now {"->"}</button>
            </div>
